    ...
    return (
        <>
            <div className="flex gap-2">
                ...
                />
                <button
                    className="bg-gray-200 px-4 hover:bg-gray-300 rounded-2xl w-auto ml-2"
            ...
            <div className="mt-2 grid gap-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 h-36 overflow-auto">
                {addedPhotos.length > 0 &&
                    addedPhotos.map((link) => (
                        <div key={link} className="flex w-40 relative">
                            ...
                            <button
                                className="absolute bottom-1 left-1 text-white bg-black p-2 rounded-xl bg-opacity-50 cursor-pointer"
                ...
                <label className="flex items-center cursor-pointer border rounded-2xl bg-gray-100 hover:bg-gray-200 text-4xl justify-center gap-2">
                    <input
                        type="file"
                        className="hidden"
